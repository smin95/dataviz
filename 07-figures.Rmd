...
chapter: Recreating the Manuscript Figures
editor_options:
...
```{r, fig.width = 7.4, fig.height= 7.4,warning = F}
...
```{r, fig.width = 7.4, fig.height= 15, warning = F}
...
```{r, fig.width = 11.1, fig.height= 3.7, warning = F}
...
ggplot(data = df, mapping = aes(x = Method, y = Value, 
  ...
  ggtitle('Slope chart') + 
  theme(plot.title = element_text(face="bold")) +
  ylab('Gene expression level') -> slope
