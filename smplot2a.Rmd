...
## How `...` parameter and `xxx.params` work
...
`xxx.params` comes in various forms across different visualizing functions in **smplot2**, such as:

- `err.params`: controls the error bar's aesthetics.
- `point.params`: controls the points' aesthetics.
- `line.params`: controls the lines' aesthetics.
- `avgLine.params`: controls the mean line's aesthetics.
- `avgPoint.params`: controls the average point's aesthetics.
- `boxplot.params`: controls the boxplot's aesthetics.
- `violin.params`: controls the violin's aesthetics.

`...` Generic parameter can affect different components of a graph all at once if there is no default.
