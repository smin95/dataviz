...
- Download **data.csv** from https://www.ses21.com/data.csv
...
- You can also plot individual data at the same time with functions from the **smplot** package.
  ...
  - **smplot** functions are not necessary to make a graph with **ggplot2**. If you don't like it, you don't have to use it.