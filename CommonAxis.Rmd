...
plots_tgd4e <- plots_tgd4c +
  sm_add_line(x = 0.5, y = 0.475, xend = 0.5, 
                           yend = 0.525, color = 'black') +
  sm_add_line(x = 0.49, y = 0.5, xend = 0.51, 
...
```{r}
plots_tgd4g <- plots_tgd4e + 
  sm_add_arrow(x  = 0.5, y = 0.37, xend = 0.5, 
                           yend = 0.46, color = 'black') +
  sm_add_arrow(x = 0.44, y = 0.5, xend = 0.46, 
...
```{r}
plots_tgd4h <- plots_tgd4g + sm_add_rect(xmin= 0.44, ymin = 0.37, xmax = 0.56, 
...
```{r}
plots_tgd4i <- plots_tgd4h + sm_add_polygon(x = c(.2,.8,.8), y = c(.2,.8,.2), 
...
```{r}
plots_tgd4j <- plots_tgd4i + sm_add_text(x=.5, y=.5,  label = 'Annotations!!', angle=42, size = 25, fontface='bold')
```
