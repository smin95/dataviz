...
xlabel2 <- sm_common_xlabel('Minutes after monocular deprivation', x= 0.52,
                           y = 0.6)
ylabel2 <- sm_common_ylabel('\u0394 Contrast balance ratio (dB)', x = 0.6)
title2 <- sm_common_title('Individual data', y = 0.2)
...
plots_tgd_legend <- sm_put_together(all_plots, title, xlabel2, ylabel2,
                                    legend=legend, ncol=5,
                                    nrow=2, margin=0)
```
