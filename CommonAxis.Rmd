...
```{r}
save_plot("together1.png", plots_tgd,
  ncol = 3, nrow = 3,
...
```{r, echo=FALSE}
save_plot("together2a.png", plots_tgd3,
  ncol = 3, nrow = 3,
  base_height = 3.4, base_width = 3
)
```
...
```{r, echo=FALSE}
save_plot("together2b.png", plots_tgd3b,
  ncol = 3, nrow = 3,
  base_height = 3.4, base_width = 3
)
```
...
save_plot("together2c.png", plots_tgd3c,
  ncol = 3, nrow = 3,
  base_height = 3.4, base_width = 3
)
```
...
```{r, warning=F, message=F}
save_plot("together4.png", plots_tgd4,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
```{r, warning=F, message=F}
save_plot("together4_quick.png", plots_tgd_quick,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
6. `labelRatio`: controls the size of the titles (labels) of both axes. This gets activated only when users supply character inputs for the labels (`title`,`xlabel`, `ylabel`, `xlabel2` or `ylabel2`). Instead, it gets ignored when users supply outputs from `sm_common_title()`, `sm_common_xaxis()` and `sm_common_yaxis()`.
...
```{r, echo=FALSE, warning=F, message=F}
save_plot("together4b.png", plots_tgd4b,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
```{r, echo=FALSE, warning=F, message=F}
save_plot("together4c.png", plots_tgd4c,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
```{r, echo=FALSE}
save_plot("together4e.png", plots_tgd4e,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
```{r, echo=FALSE, warning=F, message=F}
save_plot("together5.png", plots_tgd5,
  ncol = 5, nrow = 2,
  base_height = 3.4, base_width = 3
)
```
...
```{r, warning=F, message=F}
save_plot("mosaic.png", mosaic_tgd1,
  ncol = ncol, nrow = nrow,
  base_height = 3.4, base_width = 3
)
```
