...
If you downloaded **before Mar. 17th, 2022**, please **re-download smplot**. Some updates include： 

- New functions `sm_auc()` and `sm_auc_list()`, both of which are used for computing area under a curve. 
