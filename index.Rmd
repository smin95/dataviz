...
As of April 2024, *smplot2* is now part of the **CRAN** repository. Please install using `install.packages()` for the most stable version, and `install_github()` for the most updated version.
