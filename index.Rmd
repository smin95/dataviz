...
If you downloaded **before Feb. 17th, 2022**, please re-download it. After the update, `sm_violin()` and `sm_bar()` works properly; their errorbars of 95% confidence intervals (`errorbar_type = 'ci'`) can be displayed without an issue. 
