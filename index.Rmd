...
knitr::include_graphics("together3b.png")
```
...
[![](https://cranlogs.r-pkg.org/badges/smplot2)](https://cran.r-project.org/package=smplot2) [![CRAN_Release_Badge](http://www.r-pkg.org/badges/version-ago/smplot2)](https://CRAN.R-project.org/package=smplot2)
...
If users wish to download the most updated version of *smplot2* (most recent version: 0.2.2.2 from **2024-05-24**), please use `install_github()`. This might be necessary if some codes from the documentation webpage do not work in RStudio as intended.
