...
If you downloaded **before Feb. 21st, 2022**, please **re-download ssmplot**. Some updates are： 
- `sm_violin()` and `sm_bar()` work properly; their errorbars of 95% confidence intervals (`errorbar_type = 'ci'`) can be displayed without an issue. 
- `sm_raincloud()` works properly. However, the points can no longer be grouped. 
