...
If users wish to download the most updated version of *smplot2* (most recent version: 0.2.2.3 from **2024-05-26**), please use `install_github()`. This might be necessary if some codes from the documentation webpage do not work in RStudio as intended.
