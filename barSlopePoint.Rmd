...
This can also be produced with `sm_slope_mean()`, which is easier.

The error bar type can be selected using `errorbar_type`. The aesthetics of the error bars can be set using `err_width`. 
