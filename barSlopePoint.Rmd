...
ggplot(data = df, mapping = aes(x = Group, y = Value, fill = Group)) +
  sm_bar(bar.params = list(width = 0.5, alpha = 0.5),
         point.params = list(shape = 21, color ='white', 
                             stroke = 0.75, alpha = 1)) +
  scale_y_continuous(limits = c(0,8), expand = c(0,0.05)) +
...
```{r, fig.width = 3.5, fig.height=3.5}
ggplot(data = df, mapping = aes(x = Group, y = Value, fill = Group)) +
  sm_bar(bar.params = list(fill = 'gray60'),
         point.params = list(shape = 21, color ='white', 
                             stroke = 0.75, alpha = 1)) +
  scale_y_continuous(limits = c(0,8), expand = c(0,0.05)) +
  scale_fill_manual(values = sm_color('blue', 'orange')) 
...
ggplot(data = df, mapping = aes(x = Group, y = Value, fill = Group)) +
  sm_bar(point.params = list(shape = 21, color ='white', 
                             stroke = 0.75, alpha = 1), points = FALSE) +
  scale_y_continuous(limits = c(0,8), expand = c(0,0.05)) +
  scale_fill_manual(values = sm_color('blue', 'orange')) 
```
...
ggplot(data = df, aes(x = beforeAfter, y = Value))  +
  sm_slope_mean(labels = c('Before','After'), 
                main_shape = 17,
...
ggplot(data = df, aes(x = beforeAfter, y = Value)) +
  sm_slope(color = sm_color('purple'), 
           ...
           labels = c('Before','After'), 
           group = Subject,
           avgPoint.params = list(point = 5.5, fill = sm_color('purple'),
...
```{r,fig.width = 3.8, fig.height=3.5,warning = F}
ggplot(data = df, aes(x = Day, y = Value)) +
  sm_slope_mean(labels = c('Day 1','Day 2', 'Day 3'), 
...
ggplot(df2a, aes(x = SF, y = absBP, color = Group, group = Group)) +
  sm_pointplot(group = Subject,
               avgPoint.params = list(fill = sm_color('viridian'),
                                      shape = 21, color = 'white'),
...
ggplot(df2b, aes(x = SF, y = absBP, 
  ...
  sm_pointplot(group = Subject, show_shadow = T,
               ...
               line.params = list(alpha = 0.2, size = 0.6),
               point.params = list(alpha = 0.2, size = 0.6)) +
  scale_color_manual(values = sm_color('darkred', 'viridian'))
```
...
ggplot(df2b, aes(x = SF, y = absBP, 
  ...
  sm_pointplot(group = Subject, show_shadow = T,
               ...
               legends = TRUE) +
  scale_color_manual(values = sm_color('darkred', 'viridian')) +
  theme(legend.position = c(0.24,0.80), # position the legend's location
        legend.title = element_blank())
```
...
ggplot(df2b, aes(x = SF, y = absBP, 
  ...
  sm_pointplot(group = Subject, show_shadow = T,
               size = 1,
               position = position_dodge(width = 0.08),
               line.params = list(alpha = 0.25, size = 0.6),
               point.params = list(alpha = 0.25, size = 0.6),
               err.params = list(show.legend = FALSE),
               legends = TRUE) +
  scale_color_manual(values = sm_color('darkred', 'viridian')) +
  theme(legend.position = c(0.24,0.80),
