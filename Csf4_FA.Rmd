...
However, resampling is required to perform 95% confidence interval.

Therefore, a solution is to use a model that captures the contrast sensitivity function, compute parameters that retain the overall characteristic of the curve for each subject, and then resample the parameters with replacement. In this example, we will resample for 100 times (`nSim <- 100`).
