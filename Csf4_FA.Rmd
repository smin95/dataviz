...
It seems that two factors can describe enough of the achromatic data. The proportion of variance from these two factors are 87.7%. However, the loading scores per factor vary quite significantly, especially for the second factor (`MR2`). Therefore, there needs some more work to do to confirm whether a two-factor model is indeed adequate to capture the covariance of the achromatic data.
