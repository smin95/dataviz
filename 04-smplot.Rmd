...
## Colors and Graph Themes of smplot
...
- Therefore, instead of using `sm_color()` function to call forth the colors, you can directly write the hex codes of colors that are not included in **smplot**.
