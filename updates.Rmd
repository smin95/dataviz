...
- To forget the defaults for a plot component (ex. bar), set `forget = TRUE` and call `list()` for the component, and the visualization functions **will work the same as before** the version update (`p3` plot).
