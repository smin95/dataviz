...
In both plots, it is visually clear that at about 31 c/deg, the linear sensitivity approaches 1 (i.e., log-sensitivity = 0). We can also directly see the fitted values in the `grid` data frame and confirm our qualitative observation.
...
## Calculating the 5 parameters of all subjects, groups and conditions
